...
export type ResolvePlatform = 'twitter' | 'wallhaven' | 'unsplash' | 'vimeo' | 'bsky' | 'pinterest' | 'reddit' | 'flickr' | 'artstation' | 'dailymotion' | 'streamable' | 'redgifs' | 'sankaku' | 'twitch' | 'kick' | '9gag' | 'rutube' | 'rumble' | 'peertube' | 'loom' | 'soundcloud' | 'gallery-page';
