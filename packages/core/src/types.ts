...
export type ResolvePlatform = 'twitter' | 'wallhaven' | 'unsplash' | 'vimeo' | 'bsky' | 'pinterest' | 'reddit' | 'flickr' | 'artstation' | 'dailymotion' | 'streamable' | 'redgifs' | 'sankaku' | 'twitch' | '9gag' | 'rutube' | 'rumble' | 'peertube' | 'gallery-page';
