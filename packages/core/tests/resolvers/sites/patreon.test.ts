...
describe('patreonImagesFromHtml', () => {
  ...
  const W620 = 'eyJ3Ijo2MjB9';
  const ORIG = 'eyJhIjoxLCJwIjoxfQ==';
  const W1920 = 'eyJ3IjoxOTIwLCJ3ZSI6MX0=';
  ...
  it('keeps the largest rendition per image (original beats width-capped), scoped to the post', () => {
    ...
    const campaignAvatar = base('cccc3333', W620, '9.png', 'campaign', '14685527');
    const otherPost = base('dddd4444', ORIG, '2.png', 'post', '999999');
  ...
  it('marks a .gif original as kind gif and skips non-image attachments', () => {
    ...
    const mp4 = base('7777aaaa', ORIG, 'clip.mp4');
