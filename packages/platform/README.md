...
**Contracts and detection only, no implementations.** The concrete Chrome /
...
See the [Architecture guide](https://mralaminahamed.github.io/media-bulk-downloads/how-it-works/architecture/) for where the
