 ...
 * detection. The Chrome/Firefox/Safari IMPLEMENTATIONS live in the app layer
 * (apps/extension/src/extension/platform/*), because they hold the divergent
 * chrome.* APIs and read the WXT build-time browser flag. Keeping the contracts
 * here lets a new target be added by supplying one folder of implementations
 * without touching @mbd/core or @mbd/storage.
 */
