...
(() => {
  ...
  const first = items[0];
  root.innerHTML =
    '<div style="font:13px/1.4 system-ui,sans-serif;background:#fff;color:#111;border:1px solid #d0d0d8;border-radius:10px;padding:10px 12px;max-width:340px;box-shadow:0 4px 16px rgba(0,0,0,.18)">' +
