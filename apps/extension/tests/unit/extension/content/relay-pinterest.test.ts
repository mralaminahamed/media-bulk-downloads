...
vi.mock('@mbd/core/resolvers/sites/pinterest', async () => ({
  ...(await vi.importActual<typeof import('@mbd/core/resolvers/sites/pinterest')>('@mbd/core/resolvers/sites/pinterest')),
