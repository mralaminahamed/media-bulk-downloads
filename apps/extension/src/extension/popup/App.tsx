  ...
  return (
    <div className="ibd-app mbd:flex mbd:h-full mbd:flex-col mbd:overflow-hidden mbd:bg-(--paper) mbd:text-(--ink)">
          ...
          <div className="mbd:flex mbd:items-center mbd:gap-1.5">
            ...
            {captureOriginals && settings.fbCaptureOriginals && (
              <>
                ...
                >
                  <PhotoIcon className={`mbd:h-4.5 mbd:w-4.5 ${capturing ? 'mbd:animate-pulse' : ''}`} />
                </button>
              </>
            )}
      ...
      <main className="scroll-thin mbd:flex-1 mbd:overflow-y-auto mbd:px-4 mbd:py-3">
        {confirmCapture && (
          <div role="dialog" aria-label="Confirm original capture" className="mbd:mb-3 mbd:rounded-(--radius) mbd:border hairline mbd:bg-(--panel-2) mbd:p-3">
            <p className="mbd:text-[13px] mbd:text-(--ink)">
            ...
            <div className="mbd:mt-2 mbd:flex mbd:gap-2">
