import { filterImages, updateTabBadge, loadSettings } from '@/extension/background';
...
describe('Background Script', () => {
    ...
    describe('loadSettings', () => {
      it('loads settings from storage', () => {
        ...
        mockChrome.storage.sync.get.mockImplementation((keys : string[], callback : ( result : { [p : string] : any } ) => void ) => {
