...
export const REGISTRY: Resolver[] = [twitterResolver, instagramResolver, facebookResolver, unsplashResolver, wallhavenResolver, behanceResolver, bskyResolver, magnificResolver, youtubeResolver, genericResolver];
