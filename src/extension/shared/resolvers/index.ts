...
export const REGISTRY: Resolver[] = [twitterResolver, instagramResolver, unsplashResolver, wallhavenResolver, behanceResolver, bskyResolver, redditResolver, magnificResolver, youtubeResolver, genericResolver];
